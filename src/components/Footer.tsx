...
const socialLinks = [
  ...
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/company/wa-rover-project/',
    icon: (
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/waroverproject/',
    icon: (
...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-shell py-16 text-white md:py-24">
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5 lg:gap-12">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-body-sm text-white/60">
              ...
              team at UWA building planetary rovers for the Australian Rover
              Challenge.
            </p>
          </div>
              ...
              {socialLinks.map((social) => (
                <li key={social.name}>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-body-sm text-white/60 transition-colors hover:text-white"
                  >
                    <svg
        ...
        <div className="mt-12 border-t border-white/10 pt-6">
          <p className="text-body-sm text-white/40">
            © {currentYear} Western Australian Rover Project (WARP). All
            rights reserved.
          </p>
        </div>
      </div>
